    ...
    return (
        <div className="w-16 h-full bg-blue-50 border-r border-blue-100 flex flex-col items-center py-2 justify-between">
            ...
            <div className="flex flex-col items-center gap-1 w-full mb-1">
                <button className="p-2 text-gray-500 hover:bg-blue-100 hover:text-blue-600 rounded-xl transition-all" title="Cài đặt">
                    <Settings className="w-5 h-5" />
                </button>
                <button onClick={logout} className="p-2 text-gray-500 hover:bg-red-50 hover:text-red-500 rounded-xl transition-all" title="Đăng xuất">
